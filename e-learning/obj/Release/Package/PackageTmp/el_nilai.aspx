              ...
              <table id="pretest" style="display: none;" class="table table-bordered table-hover mt-3">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><%# If(DataBinder.Eval(Container.DataItem, "app_sta") = "1", "Correct",
                                                               If(DataBinder.Eval(Container.DataItem, "app_sta") = "0", "Incorrect", ""))
                      %></td>
                  </tr>
                   ...
                   <td> <asp:Label runat="server" Text='<%#Eval("skor") %>'></asp:Label></td>
                    ...
                    <td>
                        <div style='<%# GetItemStyle(Container.DataItem) %>'>
                            <%# If(DataBinder.Eval(Container.DataItem, "app_sta") = "1", "Correct",
                                                                                                   If(DataBinder.Eval(Container.DataItem, "app_sta") = "0", "Incorrect", ""))
                      %>
                        </div> 
