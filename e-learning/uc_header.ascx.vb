...
Public Class WebUserControl1
    ...
    Private Sub WebUserControl1_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Private Sub pivot_excel_ServerClick(sender As Object, e As EventArgs) Handles pivot_excel.ServerClick
        ...
        'pivot.OptionsData.AutoExpandGroups = DevExpress.Utils.DefaultBoolean.False


        'Me.ASPxPivotGridExporter1.ExportXlsxToResponse("Actual Report")
        Dim options As New XlsxExportOptionsEx()
        options.ExportType = ExportType.WYSIWYG
        ASPxPivotGridExporter1.OptionsPrint.MergeRowFieldValues = False
        ...
        ASPxPivotGridExporter1.ExportXlsxToResponse("Actual Report", options, True)
    End Sub
