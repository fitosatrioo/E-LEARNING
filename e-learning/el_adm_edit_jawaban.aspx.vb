...
Imports System.IO
Public Class el_adm_edit_jawaban
    ...
    Private Sub el_adm_edit_jawaban_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit

    End Sub

    Private Sub el_adm_edit_jawaban_Init(sender As Object, e As EventArgs) Handles Me.Init
