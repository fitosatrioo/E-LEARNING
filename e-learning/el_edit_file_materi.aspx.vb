...
Public Class el_edit_file_materi
    ...
    Private Sub el_edit_file_materi_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        Me.waktu_page.Stop()
    ...
    Private Sub el_edit_file_materi_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
        Me.waktu_page.Start()
    End Sub

    Private Sub el_edit_file_materi_Init(sender As Object, e As EventArgs) Handles Me.Init
        Try
