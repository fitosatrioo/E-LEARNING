<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_header.ascx.vb" Inherits="e_learning.WebUserControl1" %>
...
<div class="page-header">
    <div class="breadcrumb-line breadcrumb-top">
        <ul class="breadcrumb" runat="server" id="list_menu">
            <li><a href="el_link_form.aspx" >Link</a></li>
            <li class="active"><a href="el_adm_level.aspx" >Level</a></li>
        </ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="breadcrumb-buttons2">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="collapse" data-target="#togglegroup2" style="display:none" runat="server" id="a_filter">
        ...
        <div class="form-group">
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-3">
                        <b>Filter Column 1 :</b>
                        <asp:DropDownList ID="filter_cb1" runat="server" CssClass="select"></asp:DropDownList>
                    </div>
                    <div class="col-sm-3">
                        <b>Containt :</b>
                    ...
                    <div class="col-sm-3">
                        <b>Filter Column 2 :</b>
                        <asp:DropDownList ID="filter_cb2" runat="server" CssClass="select"></asp:DropDownList>
                    </div>
                    <div class="col-sm-3">
                        <b>Containt :</b>
        ...
        <div class="form-group" style="display:none">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-3">
                        <b>Filter Date :</b>
                        <asp:DropDownList ID="filter_cb3" runat="server" CssClass="select"></asp:DropDownList>
                    </div>
                    <div class="col-sm-3">
                        <b>From :</b>
